...
class ItemServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ListItems = channel.unary_stream(
            ...
            request_serializer=items__pb2.ListRequest.SerializeToString,
            response_deserializer=items__pb2.ItemResponse.FromString,
            _registered_method=True,
        )
...
def add_ItemServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        "ListItems": grpc.unary_stream_rpc_method_handler(
            servicer.ListItems,
            request_deserializer=items__pb2.ListRequest.FromString,
            response_serializer=items__pb2.ItemResponse.SerializeToString,
        ),
    }
    generic_handler = grpc.method_handlers_generic_handler("items.ItemService", rpc_method_handlers)
...
class ItemService(object):
    ...
    def ListItems(
        ...
        return grpc.experimental.unary_stream(
            ...
            target,
            "/items.ItemService/ListItems",
            items__pb2.ListRequest.SerializeToString,
            items__pb2.ItemResponse.FromString,
            options,
            channel_credentials,
            insecure,
